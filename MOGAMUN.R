...
#sets up the meta parameters
#' @title setUpMetaParameters
#' @description initialize meta parameters
#' @return None
#' @examples
#' setUpMetaParameters(Generations = 5,
#' setUpMetaParameters(ThresholdSignificantlyDEGenes = 0.05,
#'                     MaxNumberOfAttempts = 3,
#'                     Measure = "FDR",
#'                     NumberOfRunsToExecute = 1)
#' @export
setUpMetaParameters <- function(ThresholdSignificantlyDEGenes = 0.05,
                                MaxNumberOfAttempts = 3,
                                Measure = "FDR",
                                NumberOfRunsToExecute = 1) {
...
#' @title setUpEvolutionProcessParameters
#' @description initialize evolution parameters
#' @return None
#' @examples
#' setUpEvolutionProcessParameters(Generations = 5,
#'                                 PopSize = 100,
...
setUpEvolutionProcessParameters <- function(Generations = 500,
     ...
     MyObjectiveNames <<- MyObjectiveNames
}

# Load data for MOGAMUN
#' @title mogamun
...
#' @return None
#' @examples
#' mogamun(resultsDir = 'MOGAMUN_results/')
#' @export
mogamun <- function(resultsDir = '.') {
